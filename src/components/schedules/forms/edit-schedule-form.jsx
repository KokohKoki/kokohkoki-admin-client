...
export default function EditScheduleForm({ setIsOpen, onSubmit, scheduleName, scheduleImage }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-2 my-4 justify-start text-gray-700 mx-2 font-medium">
      <div className={classes.modalGridForm}>
        ...
        <input id="scheduleName" name="scheduleName" type="text" className={inputStyle} autoComplete="off" value={formData.scheduleName} onChange={handleChange} />
      </div>
      <div className="w-full h-[2px] bg-gray-300 opacity-75 my-2" />
      <h1 className="flex justify-center text-sm text-primary font-bold tracking-wider">Change Shipping Schedule Image</h1>
      <img src={formData.scheduleImage} className="aspect-video object-cover rounded-lg" />
      <div className={classes.modalGridForm}>
        <label htmlFor="scheduleImage">Change Image</label>
