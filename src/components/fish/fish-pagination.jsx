...
export default function FishPagination({ totalPages, paginate, currentPage }) {
  ...
  return (
    <div className="flex flex-wrap gap-2 justify-start my-2.5 px-2 py-1 text-sm bg-white w-fit rounded-lg text-gray-600">
      ...
      <button className={`flex items-center cursor-pointer ${nextDisabled ? `opacity-50 cursor-not-allowed` : `hover:text-gray-300 transition duration-300 ease-in-out`} `} onClick={nextBtn} disabled={nextDisabled}>
