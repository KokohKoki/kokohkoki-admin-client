...
export default function EditCouponForm({ setIsOpen, onSubmit, discountPercentage, discountMaxPriceIdr, discountMaxPriceUsd, expirationDate }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-2 my-4 justify-start text-gray-700 mx-2 font-medium">
      <div className={classes.modalGridForm}>
        ...
        <input id="discountPercentage" name="discountPercentage" type="text" placeholder="contoh: 50" className={inputStyle} autoComplete="off" value={formData.discountPercentage} onChange={handleChange} />
      </div>
      <div className={classes.modalGridForm}>
        <label htmlFor="discountMaxPriceIdr">Set Max Price IDR</label>
        <input id="discountMaxPriceIdr" name="discountMaxPriceIdr" type="text" placeholder="contoh: 100000" className={inputStyle} autoComplete="off" value={formData.discountMaxPriceIdr} onChange={handleChange} />
      </div>
      <div className={classes.modalGridForm}>
        <label htmlFor="discountMaxPriceUsd">Set Max Price USD</label>
        <input id="discountMaxPriceUsd" name="discountMaxPriceUsd" type="text" placeholder="contoh: 100" className={inputStyle} autoComplete="off" value={formData.discountMaxPriceUsd} onChange={handleChange} />
      </div>
      <div className="w-full h-[2px] bg-gray-300 opacity-75 my-2" />
      <div className={classes.modalGridForm}>
        <label htmlFor="expirationDate">Set Expiration Date</label>
        <input id="expirationDate" name="expirationDate" type="date" className="input input-md w-full bg-slate-400" autoComplete="off" value={formData.expirationDate} onChange={handleChange} />
      </div>
